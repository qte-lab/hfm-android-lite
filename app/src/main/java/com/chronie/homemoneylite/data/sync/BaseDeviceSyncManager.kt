...
import com.chronie.homemoneylite.data.mapper.ExpenseMapper.toEntity
...
import com.chronie.homemoneylite.domain.sync.SyncEntity
...
abstract class BaseDeviceSyncManager(
    ...
    protected suspend fun processDeviceData(deviceData: DeviceSyncData): DownloadResult {
        val conflicts = mutableListOf<com.chronie.homemoneylite.domain.model.SyncConflict>()
        var newItems = 0
        var updatedItems = 0
                ...
                try {
                    ...
                    if (localExpense == null) {
                        ...
                        if (entity.timestamp > localTimestamp) {
                            ...
                            // 冲突：本地版本更新
                            conflicts.add(
                                com.chronie.homemoneylite.domain.model.SyncConflict(
                                    entityType = "expense",
                                    entityId = entity.entityId,
                                    conflictType = com.chronie.homemoneylite.domain.model.ConflictType.UPDATE_CONFLICT,
                                    localTimestamp = localTimestamp,
                                    serverTimestamp = entity.timestamp,
                                    resolution = com.chronie.homemoneylite.domain.model.ConflictResolution.USE_LOCAL
                                )
                            )
                        }
                    }

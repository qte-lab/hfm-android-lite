...
class ExpenseRepositoryImpl @Inject constructor(
    ...
    private fun getChineseTypeName(type: com.chronie.homemoneylite.domain.model.ExpenseType): String {
        return when (type) {
            com.chronie.homemoneylite.domain.model.ExpenseType.DAILY_GOODS -> "日常用品"
            com.chronie.homemoneylite.domain.model.ExpenseType.LUXURY -> "奢侈品"
            com.chronie.homemoneylite.domain.model.ExpenseType.COMMUNICATION -> "通讯费用"
            com.chronie.homemoneylite.domain.model.ExpenseType.FOOD -> "食品"
            com.chronie.homemoneylite.domain.model.ExpenseType.SNACKS -> "零食糖果"
            com.chronie.homemoneylite.domain.model.ExpenseType.COLD_DRINKS -> "冷饮"
            com.chronie.homemoneylite.domain.model.ExpenseType.CONVENIENCE_FOOD -> "方便食品"
            com.chronie.homemoneylite.domain.model.ExpenseType.TEXTILES -> "纺织品"
            com.chronie.homemoneylite.domain.model.ExpenseType.BEVERAGES -> "饮品"
            com.chronie.homemoneylite.domain.model.ExpenseType.CONDIMENTS -> "调味品"
            com.chronie.homemoneylite.domain.model.ExpenseType.TRANSPORTATION -> "交通出行"
            com.chronie.homemoneylite.domain.model.ExpenseType.DINING -> "餐饮"
            com.chronie.homemoneylite.domain.model.ExpenseType.MEDICAL -> "医疗费用"
            com.chronie.homemoneylite.domain.model.ExpenseType.FRUITS -> "水果"
            com.chronie.homemoneylite.domain.model.ExpenseType.OTHER -> "其他"
            com.chronie.homemoneylite.domain.model.ExpenseType.SEAFOOD -> "水产品"
            com.chronie.homemoneylite.domain.model.ExpenseType.DAIRY -> "乳制品"
            com.chronie.homemoneylite.domain.model.ExpenseType.GIFTS -> "礼物人情"
            com.chronie.homemoneylite.domain.model.ExpenseType.TRAVEL -> "旅行度假"
            com.chronie.homemoneylite.domain.model.ExpenseType.GOVERNMENT -> "政务"
            com.chronie.homemoneylite.domain.model.ExpenseType.UTILITIES -> "水电煤气"
            com.chronie.homemoneylite.domain.model.ExpenseType.BEAUTY -> "美容美发"
            com.chronie.homemoneylite.domain.model.ExpenseType.BEAN_PRODUCTS -> "豆制品"
            com.chronie.homemoneylite.domain.model.ExpenseType.COSMETICS -> "个护美妆"
            com.chronie.homemoneylite.domain.model.ExpenseType.ELECTRONICS -> "电子产品"
            com.chronie.homemoneylite.domain.model.ExpenseType.HOUSEHOLD_APPLIANCES -> "家用电器"
            com.chronie.homemoneylite.domain.model.ExpenseType.HARDWARE -> "五金"
            com.chronie.homemoneylite.domain.model.ExpenseType.CLOTHING -> "服装"
        }
    }
